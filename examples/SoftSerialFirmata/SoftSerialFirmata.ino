...
#include <Servo.h> //wouldn't load from ServoFirmata.h in Arduino1.0.5
#include <utility/ServoFirmata.h>
ServoFirmata servo;

#include <Wire.h> //wouldn't load from I2CFirmata.h in Arduino1.0.5
...
#include <SoftwareSerial.h> //wouldn't load from I2CFirmata.h in Arduino1.0.5
#include <utility/SoftSerialFirmata.h>
SoftSerialFirmata softSerialFirmata;
...
#endif
#ifdef SoftSerialFirmata_h
  firmataExt.addFeature(softSerialFirmata);
#endif
#endif
